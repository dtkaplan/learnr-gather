...
1. What is the scope of `{learnr}` for teaching.
    a. Is it just for teaching about R, or might it have a larger role to play in education? For instance, my USAFA course is calculus. This question should logically come after the others, but I want to highlight the issue.
